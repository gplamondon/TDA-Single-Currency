...
if (isServer) then {
		...
		if (true) then
		{
		  _bldObj = createVehicle ["MAP_bridge_asf1_25", [13708.3, 3273.7942, -0.442], [], 0, "CAN_COLLIDE"];
		  _bldObj setDir 20.276444;
		  _bldObj setPos [13708.3, 3273.7942, -0.442];
		  _bldObj setVectorUp [0, 0, 1];
		};
								
diag_log("[denmark Pack] Skalisty Island loaded");
};
