...
BTC_get_liftable_array =
{
	...
	switch (typeOf _chopper) do
	{
		...
		case "Mi17_Civilian_DZ": {_array = ["Motorcycle","Car","Truck","Wheeled_APC","Tracked_APC"];};
		case "Mi17_DZ"         : {_array = ["Motorcycle","Car","Truck","Wheeled_APC","Tracked_APC"];};
		case "Mi17_DZE"        : {_array = ["Motorcycle","Car","Truck","Wheeled_APC","Tracked_APC"];};
